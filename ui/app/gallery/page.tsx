            ...
            <section className="flex-1 flex items-center justify-center px-4 py-20 md:py-32">
                <div className="container mx-auto text-center space-y-8">
                    ...
                    <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                        We're curating an amazing collection of creative works.
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 max-w-4xl mx-auto">
                        ...
                        <div className="p-6 rounded-lg border bg-card text-card-foreground hover:shadow-lg transition-shadow">
                            ...
                            <h3 className="text-lg font-semibold mb-2">Visual Art</h3>
                            <p className="text-sm text-muted-foreground">
                                Stunning photography and digital artwork
                            </p>
                        </div>
                        ...
                        <div className="p-6 rounded-lg border bg-card text-card-foreground hover:shadow-lg transition-shadow">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Showcasing innovative designs and concepts
                            </p>
                        </div>
                        ...
                        <div className="p-6 rounded-lg border bg-card text-card-foreground hover:shadow-lg transition-shadow">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Curated galleries organized by theme
                            </p>
                        </div>
                    </div>
