              ...
              <div className="flex flex-col items-center justify-center gap-2 text-center">
                <div className="flex items-center gap-2">
                  <div className="h-6 w-6 rounded-full bg-primary/10 flex items-center justify-center">
                    <Image src="/logo.svg" alt="JassSpace" width={12} height={12} className="h-3 w-3 object-contain" />
                  </div>
                  <span className="font-semibold text-sm">JassSpace</span>
                </div>
                <p className="text-[10px] text-muted-foreground px-4">
                  Create your own beautiful link-in-bio page
                </p>
                <span className="text-[10px] text-primary">
                  Create your free JassSpace
                </span>
              </div>
            </div>
          </div>
