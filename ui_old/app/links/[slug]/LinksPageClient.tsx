        ...
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            <div className="h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center">
              <Image src="/logo.svg" alt="JassSpace" width={20} height={20} className="h-4 w-4 object-contain" />
            </div>
            <div>
          ...
          {loadingLinks ? (
            ...
            <motion.div variants={cardVariants} className="py-16 text-center">
              <div className="h-16 w-16 rounded-full bg-muted/20 flex items-center justify-center mx-auto mb-6">
                <Image src="/logo.svg" alt="JassSpace" width={40} height={40} className="h-8 w-8 text-muted-foreground" />
              </div>
            ...
            <div className="flex flex-col items-center justify-center gap-3 text-center">
              <Link href="/" className="flex items-center gap-2 group">
                <div className="h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                  <Image src="/logo.svg" alt="JassSpace" width={28} height={28} className="object-contain" />
                </div>
                <span className="font-semibold text-lg group-hover:text-primary transition-colors">JassSpace</span>
              </Link>
              <p className="text-xs text-muted-foreground max-w-md">
                powered by JassSpace,  <a href="https://linqyard.com/account/signup" target="_blank" className="text-xs text-primary hover:underline">
                  Create your own
                </a>
              </p>
