...
export default function LinksPage() {
  ...
  const shareOnPlatform = (platform: 'whatsapp' | 'telegram' | 'twitter') => {
    const url = getShareUrl(platform);
    const text = `Check out my JassSpace profile!`;
  ...
  const downloadQrCard = async () => {
    ...
    try {
      ...
      ctx.fillText("JassSpace Profile", canvas.width / 2, 110);
      ...
      ctx.fillText("Scan to visit my JassSpace links", canvas.width / 2, qrY + qrSize + 190);
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 pb-6">
                <div className="h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center">
                  <NextImage src="/logo.svg" alt="JassSpace" width={20} height={20} className="h-4 w-4 object-contain" />
                </div>
                <div>
                ...
                <div className="sm:ml-auto flex items-center gap-2">
                  ...
                  <div className="flex items-center border rounded-lg overflow-hidden">
                    ...
                    >
                      <NextImage src="/logo.svg" alt="JassSpace" width={16} height={16} className="h-4 w-4 object-contain" />
                    </Button>
                ...
                {loadingLinks ? (
                  ...
                  <motion.div variants={cardVariants} className="py-16 text-center">
                    <div className="h-16 w-16 rounded-full bg-muted/20 flex items-center justify-center mx-auto mb-6">
                      <NextImage src="/logo.svg" alt="JassSpace" width={48} height={48} className="h-8 w-8 object-contain text-muted-foreground" />
                    </div>
        ...
        <Dialog open={isShareModalOpen} onOpenChange={setIsShareModalOpen}>
          <DialogContent className="sm:max-w-md max-h-[90vh]">
            <DialogHeader>
              ...
              <DialogDescription>
                Share your JassSpace profile across different platforms
              </DialogDescription>
            </DialogHeader>
                    ...
                    {isGeneratingQrCode ? (
                      ...
                      <>
                        ...
                        <div className="text-center space-y-1">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Scan to view my JassSpace profile
                          </p>
                        </div>
                      </>
                    ) : qrCodeError ? (
                    ...
                    <div className="flex items-center gap-2 w-full">
                      ...
                      {QR_COLOR_PRESETS.map((preset) => (
                        <button
                          ...
                          className={`h-12 flex-1 rounded-lg border-2 transition-all hover:scale-105 ${qrCodeColor === preset.color ? "border-primary ring-2 ring-primary/20" : "border-border"
                            }`}
                      ...
                      <label
                        className={`h-12 flex-1 rounded-lg border-2 transition-all hover:scale-105 cursor-pointer flex items-center justify-center ${!QR_COLOR_PRESETS.some((p) => p.color === qrCodeColor) ? "border-primary ring-2 ring-primary/20" : "border-border"
                          }`}
