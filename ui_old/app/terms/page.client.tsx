        ...
        <motion.div className="space-y-4 max-w-4xl mx-auto" variants={itemVariants}>
          ...
          <Card className="mt-6">
            ...
            <CardContent className="prose max-w-none">
              ...
              <p>Welcome to linqyard.com (“JassSpace”, “we”, “us”, or “the Service”). These Terms of Service govern your access to and use of the Service. By using the Service you accept these Terms.</p>
